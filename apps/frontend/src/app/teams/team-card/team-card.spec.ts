...
const mockVehicleSummaries: VehicleSummary[] = [
  { id: 1, nom: 'Camion', customName: null, typeNom: 'Camion', cout: 21, emplacementsUtilises: 2, emplacementsTotal: 3, equipements: [] },
  { id: 2, nom: 'Monster Truck', customName: null, typeNom: 'Monster Truck', cout: 28, emplacementsUtilises: 3, emplacementsTotal: 4, equipements: [] },
];
