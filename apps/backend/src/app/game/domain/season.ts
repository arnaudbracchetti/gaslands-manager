 ...
 * Toutes les mutations (finalizeGame, closeSeason) s'opèrent en mémoire ; le repository
 * se charge de persister l'état résultant.
 */
export class Season {
  constructor(
    readonly id: number,
    private readonly _participants: SeasonParticipant[],
    private readonly _games: Game[],
  ) {}

  get participants(): readonly SeasonParticipant[] { return this._participants; }
  ...
  findParticipant(participantId: number): SeasonParticipant {
