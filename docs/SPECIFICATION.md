...
| Mode campagne — Séquelles (15 au catalogue, achat contre des Chocs en atelier) | 🟡 Backend implémenté (catalogue, garde d'unicité/origine, Dur à Cuire, Rouille, Légende Vivante — cf. [spec/CAMPAIGN.md](spec/CAMPAIGN.md#séquelles)) — aucune UI (Temps 2, cf. ligne Atelier ci-dessus) |
